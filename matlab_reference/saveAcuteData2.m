function [filename_mat_save,filename_xlsx_save] = saveAcuteData2(...
    File,...
    filename,...
    filepath)
%% Constants
...
for channelNum = 1:16    % loop through channel data
    ...
    time_data = File.Data(channelNum).Time * N_TO_MICRO;              % time data array
    ...
    accessVoltageList_alloc = [accessVoltageList,accessVoltage_data];
