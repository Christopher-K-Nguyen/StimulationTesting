function [numOfChFromStim,quitProgram] = getChannelsFromStim(numOfStim)
%% Constants
FIRST = 1;
% Buttons
BUTTON_QUIT = 'Quit';
    ...
    for stimNum = FIRST:numOfStim                              % each stimulator
        ...
        switch errGetNChannels                                          % getting errors
            case 0                                                      % no errors
                if numOfStim > 1
                    fprintf(...
                        '\nNumber of channels in Stimulator %d: %d (%.3f %s)\n',...
                        stimNum,numOfChFromStim,endTime,unit);	% number of channels found
                else
                    fprintf('%d (%.2f %s)\n',numOfChFromStim,endTime,unit);	% number of channels found
                end
