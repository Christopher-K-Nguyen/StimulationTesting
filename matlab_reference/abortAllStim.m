function [quitProgram] = abortAllStim()
%% Constants
% Buttons
...
while errStopStimAllChannel ~= 0                                      % stop stimulating channel
    errStopStimAllChannel = PS_AbortAll();  % get errors
