function [channelSelect,numOfChannel,quitProgram] = getChannelSelect()
%% Constants
FIRST = 1;
% Buttons
...
%% Variables
allChannels = FIRST:MAX_CHANNEL_PER_STIM;
...
while confirmChannelSelect == NO
    ...
    % Channel list
    listChannel = strings(ONE,MAX_CHANNEL_PER_STIM);
    for channelNum = allChannels
    ...
    [channelSelect,listChannel_tf] = listdlg(...	% list dialog
        ...
        'Name',titleListCh,...
        'InitialValue',allChannels);           % list title
